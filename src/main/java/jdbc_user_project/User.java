...
public class User {
	...
	private String whtasappassword;
	...
	public String getWhtasappassword() {
		return whtasappassword;
	}
	public void setWhtasappassword(String whtasappassword) {
		this.whtasappassword = whtasappassword;
	}
